...
public class GetMyListings extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (user != null) {
            ArrayList<Product> myListings = SellerService.getMyListings(user.getId());

            request.setAttribute("listings", myListings);
            request.getRequestDispatcher("seller/my-listings.jsp").forward(request, response);
        } else {
